...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst sliderBlock = document.querySelector(\".portfolio-content\");\r\nconst slides = document.querySelectorAll(\".portfolio-item\");\r\n\r\nconst timeInterval = 2000;\r\nlet currentSlide = 0;\r\nlet interval;\r\n\r\nconst slider = () => {\r\n  const dotsContainer = document.querySelector(\".portfolio-dots\");\r\n  dotsContainer.innerHTML = \"\";\r\n\r\n  for (let i = 0; i < slides.length; i++) {\r\n    const dot = document.createElement(\"li\");\r\n    dot.classList.add(\"dot\");\r\n\r\n    if (i === 0) {\r\n      dot.classList.add(\"dot-active\");\r\n    }\r\n\r\n    dotsContainer.append(dot);\r\n  }\r\n\r\n  const dots = document.querySelectorAll(\".dot\");\r\n\r\n  const prevSlide = (elems, index, strClass) => {\r\n    elems[index].classList.remove(strClass);\r\n  };\r\n\r\n  const nextSlide = (elems, index, strClass) => {\r\n    elems[index].classList.add(strClass);\r\n  };\r\n\r\n  const autoSlide = () => {\r\n    prevSlide(slides, currentSlide, \"portfolio-item-active\");\r\n    prevSlide(dots, currentSlide, \"dot-active\");\r\n\r\n    currentSlide++;\r\n\r\n    if (currentSlide >= slides.length) {\r\n      currentSlide = 0;\r\n    }\r\n\r\n    nextSlide(slides, currentSlide, \"portfolio-item-active\");\r\n    nextSlide(dots, currentSlide, \"dot-active\");\r\n  };\r\n\r\n  const startSlide = (timer = 1500) => {\r\n    interval = setInterval(autoSlide, timer);\r\n  };\r\n\r\n  const stopSlide = () => {\r\n    clearInterval(interval);\r\n  };\r\n\r\n  sliderBlock.addEventListener(\"click\", (e) => {\r\n    e.preventDefault();\r\n\r\n    if (!e.target.matches(\".dot, .portfolio-btn\")) {\r\n      return;\r\n    }\r\n\r\n    prevSlide(slides, currentSlide, \"portfolio-item-active\");\r\n    prevSlide(dots, currentSlide, \"dot-active\");\r\n\r\n    if (e.target.matches(\"#arrow-right\")) {\r\n      currentSlide++;\r\n    } else if (e.target.matches(\"#arrow-left\")) {\r\n      currentSlide--;\r\n    } else if (e.target.classList.contains(\"dot\")) {\r\n      dots.forEach((dot, index) => {\r\n        if (e.target === dot) {\r\n          currentSlide = index;\r\n        }\r\n      });\r\n    }\r\n\r\n    if (currentSlide >= slides.length) {\r\n      currentSlide = 0;\r\n    }\r\n\r\n    if (currentSlide < 0) {\r\n      currentSlide = slides.length - 1;\r\n    }\r\n\r\n    nextSlide(slides, currentSlide, \"portfolio-item-active\");\r\n    nextSlide(dots, currentSlide, \"dot-active\");\r\n  });\r\n\r\n  sliderBlock.addEventListener(\r\n    \"mouseenter\",\r\n    (e) => {\r\n      if (e.target.matches(\".dot, .portfolio-btn\")) {\r\n        stopSlide();\r\n      }\r\n    },\r\n    true,\r\n  );\r\n\r\n  sliderBlock.addEventListener(\r\n    \"mouseleave\",\r\n    (e) => {\r\n      if (e.target.matches(\".dot, .portfolio-btn\")) {\r\n        startSlide(timeInterval);\r\n      }\r\n    },\r\n    true,\r\n  );\r\n\r\n  startSlide(timeInterval);\r\n};\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (slider);\r\n\r\n\r\n// Усложненное задание к уроку №23\r\n\r\n// const timeInterval = 2000;\r\n// let currentSlide = 0;\r\n// let interval;\r\n\r\n// const slider = (settings) => {\r\n//   const sliderBlock = document.querySelector(settings.sliderBlockSelector);\r\n//   const slides = document.querySelectorAll(settings.slidesSelector);\r\n\r\n//   if (!sliderBlock) return;\r\n//   if (slides.length === 0) return;\r\n\r\n//   const dotsContainer = document.querySelector(\".portfolio-dots\");\r\n\r\n//   dotsContainer.innerHTML = \"\";\r\n\r\n//   for (let i = 0; i < slides.length; i++) {\r\n//     const dot = document.createElement(\"li\");\r\n//     dot.classList.add(\"dot\");\r\n\r\n//     if (i === 0) {\r\n//       dot.classList.add(settings.dotActiveClass || \"dot-active\");\r\n//     }\r\n\r\n//     dotsContainer.append(dot);\r\n//   }\r\n\r\n//   const dots = document.querySelectorAll(\".dot\");\r\n\r\n//   const prevSlide = (elems, index, strClass) => {\r\n//     elems[index].classList.remove(strClass);\r\n//   };\r\n\r\n//   const nextSlide = (elems, index, strClass) => {\r\n//     elems[index].classList.add(strClass);\r\n//   };\r\n\r\n//   const autoSlide = () => {\r\n//     prevSlide(\r\n//       slides,\r\n//       currentSlide,\r\n//       settings.slideActiveClass || \"slide-active\",\r\n//     );\r\n//     prevSlide(dots, currentSlide, settings.dotActiveClass || \"dot-active\");\r\n\r\n//     currentSlide++;\r\n\r\n//     if (currentSlide >= slides.length) {\r\n//       currentSlide = 0;\r\n//     }\r\n\r\n//     nextSlide(\r\n//       slides,\r\n//       currentSlide,\r\n//       settings.slideActiveClass || \"slide-active\",\r\n//     );\r\n//     nextSlide(dots, currentSlide, settings.dotActiveClass || \"dot-active\");\r\n//   };\r\n\r\n//   const startSlide = (timer = 1500) => {\r\n//     interval = setInterval(autoSlide, timer);\r\n//   };\r\n\r\n//   const stopSlide = () => {\r\n//     clearInterval(interval);\r\n//   };\r\n\r\n//   sliderBlock.addEventListener(\"click\", (e) => {\r\n//     e.preventDefault();\r\n\r\n//     if (!e.target.matches(\".dot, .portfolio-btn\")) {\r\n//       return;\r\n//     }\r\n\r\n//     prevSlide(\r\n//       slides,\r\n//       currentSlide,\r\n//       settings.slideActiveClass || \"slide-active\",\r\n//     );\r\n//     prevSlide(dots, currentSlide, settings.dotActiveClass || \"dot-active\");\r\n\r\n//     if (e.target.matches(\"#arrow-right\")) {\r\n//       currentSlide++;\r\n//     } else if (e.target.matches(\"#arrow-left\")) {\r\n//       currentSlide--;\r\n//     } else if (e.target.classList.contains(\"dot\")) {\r\n//       dots.forEach((dot, index) => {\r\n//         if (e.target === dot) {\r\n//           currentSlide = index;\r\n//         }\r\n//       });\r\n//     }\r\n\r\n//     if (currentSlide >= slides.length) {\r\n//       currentSlide = 0;\r\n//     }\r\n\r\n//     if (currentSlide < 0) {\r\n//       currentSlide = slides.length - 1;\r\n//     }\r\n\r\n//     nextSlide(\r\n//       slides,\r\n//       currentSlide,\r\n//       settings.slideActiveClass || \"slide-active\",\r\n//     );\r\n//     nextSlide(dots, currentSlide, settings.dotActiveClass || \"dot-active\");\r\n//   });\r\n\r\n//   sliderBlock.addEventListener(\r\n//     \"mouseenter\",\r\n//     (e) => {\r\n//       if (e.target.matches(\".dot, .portfolio-btn\")) {\r\n//         stopSlide();\r\n//       }\r\n//     },\r\n//     true,\r\n//   );\r\n\r\n//   sliderBlock.addEventListener(\r\n//     \"mouseleave\",\r\n//     (e) => {\r\n//       if (e.target.matches(\".dot, .portfolio-btn\")) {\r\n//         startSlide(timeInterval);\r\n//       }\r\n//     },\r\n//     true,\r\n//   );\r\n\r\n//   startSlide(timeInterval);\r\n// };\r\n\r\n// export default slider;\r\n\n\n//# sourceURL=webpack:///./modules/slider.js?\n}");
